...
<body>
	...
	<h2 style="color: pink; font-size: 40px;" align="center">THIS IS Devops class</h2>
        <h2 style="color: purple; font-size: 40px;" align="center">NOw learning jenkins class</h2>
